...
export async function main(ns: any) {
    ...
    */
    ...
    const removeByClassName = (sel: any) => doc.querySelectorAll(sel).forEach((el: any) => el.remove());
    const colorByClassName = (sel: any, col: any) => doc.querySelectorAll(sel).forEach((el: any) => el.style.color = col);
